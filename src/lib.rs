...
mod tests {
    ...
    fn test_control_flow_type_checking() {
        ...
        let result = type_checker.check(&crate::parser::ast::AstNode::程序(ast));
        ...
        match result {
            ...
            Err(crate::semantic::type_checker::TypeError::General { ref message, .. }) => {
