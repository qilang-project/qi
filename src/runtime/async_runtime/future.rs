...
pub extern "C" fn qi_future_await_i64(future: *mut Future) -> i64 {
    ...
    if unsafe { crate::runtime::async_runtime::coro::is_coro(future as *const _) } {
        return crate::runtime::async_runtime::coro::qi_coro_await_i64(future as *mut _);
    }
...
pub extern "C" fn qi_future_await_f64(future: *mut Future) -> f64 {
    ...
    if unsafe { crate::runtime::async_runtime::coro::is_coro(future as *const _) } {
        let bits = crate::runtime::async_runtime::coro::qi_coro_await_i64(future as *mut _);
...
pub extern "C" fn qi_future_await_bool(future: *mut Future) -> i32 {
    ...
    if unsafe { crate::runtime::async_runtime::coro::is_coro(future as *const _) } {
        return (crate::runtime::async_runtime::coro::qi_coro_await_i64(future as *mut _) != 0)
            as i32;
    }
