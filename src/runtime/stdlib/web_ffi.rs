...
pub extern "C" fn qi_web_cache_body_register(
    ...
    let ka_h = crate::runtime::stdlib::bytes_ffi::register_persistent_bytes(ka);
    let close_h = crate::runtime::stdlib::bytes_ffi::register_persistent_bytes(close);
...
pub extern "C" fn qi_web_parse_request_bytes(bytes_handle: i64) -> *mut RequestParts {
    ...
    match crate::runtime::stdlib::bytes_ffi::with_bytes(bytes_handle, parse_http_request) {
...
pub extern "C" fn qi_web_request_is_complete(bytes_handle: i64) -> i64 {
    crate::runtime::stdlib::bytes_ffi::with_bytes(bytes_handle, |bytes| {
        // 寻找 headers/body 边界
