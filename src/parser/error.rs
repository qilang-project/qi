...
impl ParserErrorRecovery {
    ...
    fn token_kind_to_string(&self, kind: &TokenKind) -> String {
        match kind {
            ...
            TokenKind::中文左括号 => "（".to_string(),
            TokenKind::中文右括号 => "）".to_string(),
            TokenKind::左方括号 => "[".to_string(),
            TokenKind::右方括号 => "]".to_string(),
            TokenKind::左大括号 => "{".to_string(),
            TokenKind::右大括号 => "}".to_string(),
            TokenKind::中文左大括号 => "【".to_string(),
            TokenKind::中文右大括号 => "】".to_string(),
            TokenKind::分号 => ";".to_string(),
            TokenKind::中文分号 => "；".to_string(),
            TokenKind::逗号 => ",".to_string(),
            TokenKind::中文逗号 => "，".to_string(),
            TokenKind::冒号 => ":".to_string(),
            TokenKind::双冒号 => "::".to_string(),
            ...
            TokenKind::取地址 => "&".to_string(),
            TokenKind::赋值 => "=".to_string(),
            TokenKind::加等 => "+=".to_string(),
            TokenKind::减等 => "-=".to_string(),
            TokenKind::乘等 => "*=".to_string(),
            TokenKind::除等 => "/=".to_string(),
            TokenKind::取余等 => "%=".to_string(),
            ...
            TokenKind::解引用 => "解引用".to_string(),
            TokenKind::取地址关键字 => "取地址".to_string(),
