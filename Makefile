...
#   make ci               CI 跑的全部（= check test regress examples debuginfo grpc）
...
.PHONY: help build runtime test regress examples debuginfo grpc check lint-strict ci install \
...
ci: check test regress examples debuginfo grpc
